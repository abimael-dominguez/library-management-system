...
const TRANSLATIONS = {
    es: {
        ...
        'workspace.syncError': '{count} errores de datos',
        ...
        'import.blocked': 'Bloqueado',
        'import.healthy': 'Saludable',
        'import.errorText': 'La última sincronización detectó {count} error(es) bloqueantes. Corrige el CSV antes del próximo import.',
    ...
    en: {
        ...
        'workspace.syncError': '{count} data errors',
        ...
        'import.blocked': 'Blocked',
        'import.healthy': 'Healthy',
        'import.errorText': 'The last sync found {count} blocking error(s). Fix the CSV before the next import.',
